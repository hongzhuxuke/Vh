...
LocaleNativeName nativeNames[] =
{
    ...
    {TEXT("ar"), TEXT("???????")},
    {TEXT("as"), TEXT("???????")},
    {TEXT("av"), TEXT("авар мац?, маг?арул мац?")},
    {TEXT("ay"), TEXT("aymar aru")},
    {TEXT("az"), TEXT("az?rbaycan dili")},
    {TEXT("ba"), TEXT("баш?орт теле")},
    ...
    {TEXT("cu"), TEXT("?зыкъ слов?ньскъ")},
    {TEXT("cv"), TEXT("ч?ваш ч?лхи")},
