...
//QString CPathManager::GetClassIniPath()
//{
//	QString strAppDataPath = QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation);
//
//	//int iPos = strAppDataPath.lastIndexOf("/");
//	//strAppDataPath = strAppDataPath.mid(0, iPos);
//	strAppDataPath.append("\\VhallClassHelper\\");
//	return strAppDataPath;
//}
...
QString CPathManager::GetClassConfigPath()
{
	QString strAppDataPath = QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation);

	//int iPos = strAppDataPath.lastIndexOf("/");
	//strAppDataPath = strAppDataPath.mid(0, iPos);
	strAppDataPath.append("\\VhallClass\\");


   //QString strAppDataPath = QStandardPaths::writableLocation(QStandardPaths::AppDataLocation);
   QString strConfigPath = strAppDataPath + "\\" + QString::fromStdWString(VHALL_CLASS_TOOL_CONFIG);
   return strConfigPath;
}

std::wstring CPathManager::qToStdWString(const QString &str)
{
#ifdef _MSC_VER
...
QString CPathManager::GetString(QString s, int iwPx)
{
	QString temp = s;
	QRegExp rx("[\u4e00-\u9fa5]");
