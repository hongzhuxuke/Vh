...
#define TOOLTIPQSS "QToolTip{ border:1px solid rgb(0, 0, 0, 1); background-color: rgba(0, 0, 0, 178); color:#ffffff; font-size:12px; }"
//#define LABELTIPQSS "QLabel{ border:1px solid rgb(0, 0, 0, 1); background-color: rgba(0, 0, 0, 178); color:#ffffff; font-size:12px; }"
/*录制状态*/
enum eRecordState
{
