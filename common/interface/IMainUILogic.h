...
public:
   ...
   virtual void STDMETHODCALLTYPE GetRenderPos(int& x, int& y) = 0;

   virtual void STDMETHODCALLTYPE GetLiveActiveMediaPlayBasePos(void** apContentWidget, int type = 0) = 0;
   ...
   virtual bool STDMETHODCALLTYPE StartCreateRecord() = 0;
   ...
   virtual bool STDMETHODCALLTYPE SetEnabledInteractive(const bool& bEnabled = false) = 0;
   /**
   @brief 打开文件播放。
