...
HttpProxyGetInfo::HttpProxyGetInfo()
{
...
int HttpProxyGetInfo::GetProxyInfoFromBrowser(QString &ip, int &port, QString &userName, QString &userPwd) {
...
int HttpProxyGetInfo::GetProxyIP(QString &ip, int &port, QString &userName, QString &userPwd) {
   HKEY hOpen;
...
void HttpProxyGetInfo::GetProxyUserInfo(const QString httpProxy, QString &userName, QString &userPwd) {
   DWORD dwCount = 0;
...
void HttpProxyGetInfo::SplitProxyIPInfo(const QString httpProxy, QString &ip, int &port) {
   //172.16.11.191:8081
...
bool HttpProxyGetInfo::IsEnableInternetProxy() {
